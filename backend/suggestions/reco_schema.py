...
- Always output the top 20 items with the highest score. If there are less than 20 items in total, output all items with their score. All items should have a score between 0 and 100.
